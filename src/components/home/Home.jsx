...
<div className="hero">
   ...
   <div className="hero_container">
      ...
      <div className="cRight">
         <h1> Your journey to  <br/>the glorious Quran</h1>
         <h2>Learn with the best Tutors you choose for Tajweed, 
            Recitation, Hifz and Arabic lessons, in your feasible timings...
         </h2>
         <select>
...
<div className="section_without">
   <div className="sub_section">
      <div className="co_title">
         <h2>Why Qari Jee?</h2>
         <p>Magnam dolores commodi suscipit. Necessitatibus eius consequatur ex aliquid fuga eum quidem. Sit sint consectetur velit. Quisquam quos quisquam cupiditate. Et nemo qui impedit suscipit 
